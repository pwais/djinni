...
CJNIEXPORT void JNICALL Java_com_dropbox_textsort_SortItems_runSortItems(JNIEnv* jniEnv, jobject /*this*/, jobject j_items)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
        ::textsort::SortItems::run_sort_items(::djinni_generated::NativeItemList::toCpp(jniEnv, j_items));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}

CJNIEXPORT void JNICALL Java_com_dropbox_textsort_SortItems_runSortBuffers(JNIEnv* jniEnv, jobject /*this*/, jobject j_items)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
        ::textsort::SortItems::run_sort_buffers(::djinni_generated::NativeBufferList::toCpp(jniEnv, j_items));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}
